...
# Best practice in CodeWars:
    ...
    # (a..b).inject(:+): sum numbers in range a..b, eg. (1..3).ingject(:+) = 1 + 2 + 3 => 6
    # table.inject(0,:+): sum numbers in table. Need to set intial value as '0' to avoid TypeError (in the case that table is any empty array)
